...
public class BoardController {
	...
	public void writeSave(MultipartHttpServletRequest mul /*form 안의 내용이 들어옴*/, HttpServletResponse response, HttpServletRequest request/*설정에 필요*/) throws IOException {
	...
	@GetMapping("/delete")
	public void boardDelete(@RequestParam("writeNo") int write_no, @RequestParam("imageFileName") String imageFileName,
